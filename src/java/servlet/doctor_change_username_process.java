...
@WebServlet(name = "doctor_change_username_process", urlPatterns = {"/doctor_change_username_process"})
public class doctor_change_username_process extends HttpServlet {
        ...
        throws ServletException, IOException 
            {
                ...
                if (old_username.equals(username))
                {
                    ...
                    if (username.equals(new_username))
                    {
                        ...
                        response.sendRedirect("doctor_change_username.jsp");
                    }
                    ...
                    if ( chk.equals("clear"))
                        {
                            ...
                            ResultSet rsConfirm;
                            String stAdd = "update doctor set username = ? where count ='"+ session.getAttribute("doctorID")+"'";
                            ...
                            if (rsConfirm.next()) 
                            {
                                ...
                                String sqlLog = "insert into log(acct_type, username, date, change_type, description,time) values ('doctor', '"+username+"','"+cdate+"','Update Details','Change Username from "+old_username+" to "+new_username+"','"+ct+"')";
