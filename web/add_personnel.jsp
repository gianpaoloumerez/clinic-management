<form action="add_personnel_process" method="post">
            <div class="row">
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8 add_patient">
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            <br>
                            <p>Name : <input id="patient_name" name="name" class="form-control inpt" id="focusedInput" type="text" placeholder="Personnel's Full Name" required></p>
                            <p>Birth Date : <input id="patient_bdate" name="bdate" class="form-control inpt" id="focusedInput" type="date" required></p>
                            <!--<p>Age : <input id="patient_age" name="age" class="form-control inpt" id="focusedInput" type="text" disabled value = "<%//@ include file="patient_age.jsp" %>"></p>
                         --><p>Telephone : <input id="patient_telephone" name="tel" class="form-control inpt" id="focusedInput" type="mobile" placeholder="e.g. 12345678" pattern="[0-9]{8,}" required></p>
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            <p>Username: <input id="patient_bdate" name="personnel_username" class="form-control inpt" id="focusedInput" type="text" placeholder="e.g. myname1234" required></p>
                            <p>Password : <input id="patient_age" name="personnel_password" class="form-control inpt" id="focusedInput" type="password" required></p>
                            <br>
                            <p><input type="reset" name="submit_patient" class="btn btn-primary btn-user btn-block btnclr"  value="  Clear Inputs"></p>
                            <p><input type="button" name="submit_confirm" class="btn btn-primary btn-user btn-block btnadd"  data-toggle="modal" data-target="#confirm_modal" value="  Add Personnel "></p>
