    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid center">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Account Details</h1>
            ...
            <div class="row">
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-2">
                            ...
                            <%
                            String view_Doctor =  "select * from doctor where count = '"+session.getAttribute("doctor_id")+"'";
                            Statement stDoctor = con.createStatement();
                            ResultSet rsDoctor;
                            rsDoctor = stDoctor.executeQuery(view_Doctor);
                            while (rsDoctor.next())
                            {
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_view_doctor.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Cancel</a><%
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8 add_patient">
                    <form action="edit_doctor_process" method="post"> 
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            <p>Name : <input id="patient_name" name="name" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsDoctor.getString("name")%>'></p><%
                                %><p>Birth Date : <input id="patient_bdate" name="bdate" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsDoctor.getString("birthday")%>'></p><%
                                ...
                                %>Mobile : <div class="row" style =" font-size: 20px"> &nbsp +63 &nbsp <input id="patient_mobile" name="mobile" class="form-control inpt" id="focusedInput" pattern="[0-9]{10,}" style =" width:75%"value = '<%=rsDoctor.getString("phone")%>'></div><%
                                %><p>Email :<input id="sex" name="email" class="form-control inpt" id="focusedInput" type="email" value = '<%=rsDoctor.getString("email")%>'></p><%
                                %><p>Sex : <select class="form-control inpt" name="sex" value = '<%=rsDoctor.getString("gender")%>' required>
                            ...
                            <% if (rsDoctor.getString("status").equals("Single"))
                                ...
                                } else if (rsDoctor.getString("status").equals("Widowed"))
                               {
                                ...
                                %>
                            <p>Username : <input id="patient_height" name="username" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsDoctor.getString("username")%>' disabled></p>
                            <p>Department : <select  class="form-control inpt" name="department" value = '<%=rsDoctor.getString("dept")%>' required>
                                                <%
