...
<%
    try
    {
    if (session.getAttribute("r_doctor_id").equals(""))
    {
...
<html>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <span><a class="h3 mb-4 text-gray-800"> <i class="fa fa-calendar-plus-o" aria-hidden="true"></i> Select Date & Time </a><a class = "h5">/ Select Doctor / Select Patient / Set Reservation</a></span> 
          
          <br>
          <h3 style="color: #d62516"><% try {if(session.getAttribute("appointment_message_date").equals(null)){out.print(" ");} else {out.print("<br>"+session.getAttribute("appointment_message"));}} catch (Exception e) {out.print(" ");}%></h3>
          <br>
          <div class ="row">
    ...
    <div class="card shadow mb-4 cardcustom">
        ...
        <div class=" py-3 tablebg">
            <div class ="row">
                <h5 class="m-0 font-weight-bold"> &nbsp; &nbsp; &nbsp; <i class="fa fa-calendar" aria-hidden="true"></i> Select Date & Time</h5>
             </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="appointment_confirm" method="post">
                <p>Select Date : <input id="appointment_date" name="appt_date" class="form-control inpt" id="focusedInput" type="date" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required></p>
                <br>
                <p>Select Time : <input id="appointment_time" name="appt_time" class="form-control inpt" id="focusedInput" type="time" min="08:00" max="17:00" required></p>
                ...
                <div class="modal fade" id="confirm_modal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
                    ...
                    <button class="btn btn-primary btn-user btn-block btnedit" data-toggle="modal" data-target="#confirm_modal" style = "height: 45px"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> &nbsp; Set Appointment</button>
                    <br>
                    <a class="btn btn-secondary btn-user btn-block btnedit" href="personnel_select_doctor_resv.jsp"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> &nbsp;Go Back</a>
