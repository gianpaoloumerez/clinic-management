          ...
          <h1 class="h3 mb-4 text-gray-800"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Account Details</h1>
            ...
            <div class="row">
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-2">
                            ...
                            while (rsDoctor.next())
                            {
                                ...
                                Integer age = 0;
                                    ...
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_view_personnel.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Cancel</a><%
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8 add_patient">
                    <form action="edit_personnel_process" method="post"> 
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            <p>Name : <input id="patient_name" name="name" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsDoctor.getString("name")%>'></p><%
                                ...
                                %><p>Telephone : <input id="patient_telephone" name="tel" class="form-control inpt" id="focusedInput"  pattern="[0-9]{8,}" type="text" value = '<%=rsDoctor.getString("tphone")%>'></p><%
                                %>Mobile : <div class="row" style =" font-size: 20px"> &nbsp +63 &nbsp <input id="patient_mobile" name="mobile" pattern="[0-9]{10,}" class="form-control inpt" id="focusedInput" style =" width:75%"value = '<%=rsDoctor.getString("phone")%>'></div><%
