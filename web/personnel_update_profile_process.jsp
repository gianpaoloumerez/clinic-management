...
<%
    ...
    String password = request.getParameter("password");
            ...
            if (age > -1)
            {
                ...
                ResultSet rsConfirm;
                String stAdd = "update receptionist set name = ?,  address = ?, phone = ?, tphone = ?, status = ?, email = ?,  date_updated = ? where count ='"+ session.getAttribute("personnelID")+"'";
                ...
                if (rsConfirm.next()) 
                {
                    ...
                    String sqlLog = "insert into log(acct_type, username, date, change_type, description,time) values ('personnel', '"+username+"','"+cdate+"','Update Details','Edited Profile "+name+"','"+ct+"')";
                    ...
                    response.sendRedirect("personnel_update_profile.jsp");
                } 
                else
                {
