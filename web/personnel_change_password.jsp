    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid center">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Change Password</h1>
            ...
            <div class="row">
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-7 add_patient">
                    ...
                    <form action="personnel_change_password_process.jsp" method="post"> 
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8">
                            <br>
                            <p>Current Password : <input name="c_password" class="form-control inpt" id="focusedInput" type="password" required></p>
                            <p>New Password : <input  name="n_password" class="form-control inpt" id="focusedInput" type="password" required></p>
