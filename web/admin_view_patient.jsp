            ...
            <div class="row">
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-2">
                            ...
                            while (rsPatient.next())
                            {
                                ...
                                {
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_search_patient.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Go Back</a>
                    <p><a class="btn btn-primary btn-user btn-block btnedit" href="admin_view_patient_edit.jsp"> &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                    <!--<p><a class="btn btn-primary btn-success btn-user btn-block btnedit" href=""> &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Set Appointment</a>--><%
                                }
                                else
                                {
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_search_patient_da.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Go Back</a>
                                    <p><a class="btn btn-primary btn-user btn-block btnedit" href="admin_view_patient_edit.jsp"> &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><%
                                }
