                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            <br>
                                ...
                                %>Patients Weight :<div class ="row" style="font-size: 20px">&nbsp;&nbsp;<input id="patient_weight" name="weight" class="form-control inpt" id="focusedInput" type="text" style =" width:75%" value = '<%=rsPatient.getString("weight")%>'disabled> &nbsp;Kg</div>
                                <br>Patients Height : <div class ="row" style="font-size: 20px">&nbsp;&nbsp;<input id="patient_height" name="height" class="form-control inpt" id="focusedInput" type="text" style =" width:75%" value = '<%=rsPatient.getString("weight")%>'disabled> &nbsp;M</div>
                                <br>Patient Blood Pressure : <div class ="row" style="font-size: 20px"> &nbsp;&nbsp; <input id="patient_age" name="bp1" class="form-control inpt" pattern="[0-9]{8,1}" style =" width:40%" id="focusedInput" type="number" value = '<%=rsPatient.getString("bp1")%>'disabled> &nbsp;/&nbsp; <input id="patient_age" name="bp2" class="form-control inpt" pattern="[0-9]{8,1}" style =" width:40%"id="focusedInput" type="number" value = '<%=rsPatient.getString("bp2")%>'disabled>
                                </div>
                                <br>
                                </div>
                                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-1">
