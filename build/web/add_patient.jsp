<form action="add_patient_process" method="post">
            <div class="row">
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8 add_patient">
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            <br>
                            <p>Name : <input id="patient_name" name="name" class="form-control inpt" id="focusedInput" type="text" placeholder="Patient's Full Name" required></p>
                            <p>Birth Date : <input id="patient_bdate" name="bdate" class="form-control inpt" id="focusedInput" type="date" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" placeholder="Patient's Birth Date" required></p>
                         ...
                         --><p>Sex : <select class="form-control inpt" name = "sex" required>
                            ...
                            <p>Address : <input id="patient_address" name="address" class="form-control inpt" id="focusedInput" type="text" placeholder="Patient's Address" required></p>
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            <p>Telephone : <input id="patient_telephone" name="tel" class="form-control inpt" id="focusedInput" type="text" pattern="[0-9]{8,}" placeholder="Patient's Telephone Number" required></p>
                            ...
                            <p><input type="button" name="submit_confirm" class="btn btn-primary btn-user btn-block btnadd"  data-toggle="modal" data-target="#confirm_modal" value="  Add Patient "></p>
