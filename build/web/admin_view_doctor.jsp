    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid center">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"> <i class="fa fa-id-card" aria-hidden="true"></i> View Doctor Details</h1>
            ...
            <div class="row">
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-2">
                            ...
                            while (rsDoctor.next())
                            {
                                ...
                                {
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_search_doctor.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Go Back</a>
                    <p><a class="btn btn-primary btn-user btn-block btnedit" href="admin_view_doctor_edit.jsp"> &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><%
                                }
                                else
                                {
                                    %><p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_search_doctor_da.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Go Back</a>
                                    <p><a class="btn btn-primary btn-user btn-block btnedit" href="admin_view_doctor_edit.jsp"> &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><%
                                }
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-8 add_patient">
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            <p>Department:  <input id="patient_weight" name="weight" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsDoctor.getString("dept")%>'disabled></p><%
                            if (rsDoctor.getString("acct_status").equals("active"))
                                {
