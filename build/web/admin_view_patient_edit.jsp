          ...
          <h1 class="h3 mb-4 text-gray-800"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Patient Details</h1>
            ...
            <div class="row">
                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-2">
                            ...
                            <p><a class="btn btn-secondary btn-user btn-block btnbck" href="admin_view_patient.jsp"> &nbsp;<i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Cancel</a>
                    ...
                    <div class="row">  
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                            ...
                            while (rsPatient.next())
                            {
                                ...
                                %><p>Name : <input id="patient_name" name="name" class="form-control inpt" id="focusedInput" type="text" value = '<%=rsPatient.getString("name")%>'required></p><%
                                %><p>Birth Date : <input id="patient_bdate" name="bdate" class="form-control inpt" id="focusedInput" type="date" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" value = '<%=rsPatient.getString("birthday")%>'required></p><%
                                ...
                                <div class="col-xs-11 col-sm-11 col-md-11 col-xl-4">
                                <br>                            
                            <p>Sex : <select class="form-control inpt" name = "sex" value = '<%=rsPatient.getString("gender")%>' required>
